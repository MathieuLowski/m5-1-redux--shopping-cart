...
import { useDispatch } from "react-redux"; //Redux hook (call when you want to notify redux when something happened)
import { addItem } from "../action"; //might have to dbl check the path
